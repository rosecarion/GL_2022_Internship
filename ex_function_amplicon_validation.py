        ...
        if not single_ended:
            ...
            for raw_R_suffix in raw_R_suffixes:
                with vp.payload(
                    payloads=[
                        {
                            "sample":sample + raw_R_suffix, "file_prefixes_in_multiqc" : file_prefixes_in_multiqc
                        }
                    ]
                ):
            ...
            with vp.payload(
                payloads=[
                    {
                        "sample" : sample + suffix, "file_prefixes_in_multiqc" : file_prefixes_in_multiqc
                    }
                ]
            ):
                vp.add(check_raw_multiqc_outputs)
        ...
        if not single_ended:
            ...
            for filtered_R_suffix in filtered_R_suffixes:
                with vp.payload(
                    payloads=[
                        {
                            "sample" : sample + filtered_R_suffix, "file_prefixes_in_multiqc" : file_prefixes_in_multiqc
                        }
                    ]
                ):
